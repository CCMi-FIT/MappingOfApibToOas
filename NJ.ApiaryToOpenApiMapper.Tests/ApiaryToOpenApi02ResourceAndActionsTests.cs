...
{
  public class ApiaryToOpenApi02ResourceAndActionsTests
  {
    [Fact]
    public void ApiaryToOpenApi02ResourceAndActionsTest()
    {
...
+ [Next: Named Resource and Actions](03.%20Named%20Resource%20and%20Actions.md)"
      ...
      apb.ResourceSections = new List<ResourceSection>
      {
        messageResource
      };

      ApiaryToOpenApiTestRunner.RunTest(apb, "TestFiles/02. Resource and Actions.json");
    }
  }
}
