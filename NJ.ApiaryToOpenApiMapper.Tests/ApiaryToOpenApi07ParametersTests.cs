...
{
  public class ApiaryToOpenApi07ParametersTests
  {
    [Fact]
    public void ApiaryToOpenApi07ParametersTest()
    {
...
+ [Next: Attributes](08.%20Attributes.md)"
      ...
      ApiaryToOpenApiTestRunner.RunTest(apb, "TestFiles/07. Parameters.json");
    }
  }
}
