...
{
  public class ApiaryToOpenApi04GroupingResourcesTests
  {
    [Fact]
    public void ApiaryToOpenApi04GroupingResourcesTest()
    {
...
here and as such we will omit it from the next installment of this course."
      ...
      apb.ResourceGroupSections = new[] { messagesResourceGroup, usersResourceGroup };
...
+ [Next: Responses](05.%20Responses.md)"
      ...
      ApiaryToOpenApiTestRunner.RunTest(apb, "TestFiles/04. Grouping Resources.json");
    }
  }
}
