...
{
  public class ApiaryToOpenApi10DataStructuresTests
  {
    [Fact]
    public void ApiaryToOpenApi10DataStructuresTest()
    {
    ...
    ""redeem_by"": null
      ...
      apb.DataStructuresSections = dataStructures;
...
+ [Next: Resource Model](11.%20Resource%20Model.md)"
      ...
      ApiaryToOpenApiTestRunner.RunTest(apb, "TestFiles/10. Data Structures - 02.json");
    }
  }
}
