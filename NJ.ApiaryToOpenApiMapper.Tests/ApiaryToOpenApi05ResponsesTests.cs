...
{
  public class ApiaryToOpenApi05ResponsesTests
  {
    [Fact]
    public void ApiaryToOpenApi05ResponsesTest()
    {
...
+ [Next: Requests](06.%20Requests.md)"
      ...
      ApiaryToOpenApiTestRunner.RunTest(apb, "TestFiles/05. Responses.json");
    }
  }
}
