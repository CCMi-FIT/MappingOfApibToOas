...
{
  public class ApiaryToOpenApi09AttributesTests
  {
    [Fact]
    public void ApiaryToOpenApi09AttributesTest()
    {
...
+ [Next: Data Structures](10.%20Data%20Structures.md)"
      ...
      ApiaryToOpenApiTestRunner.RunTest(apb, "TestFiles/09. Advanced Attributes.json");
    }
  }
}
